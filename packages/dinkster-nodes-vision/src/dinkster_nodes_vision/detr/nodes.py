"""Stable node shape and boundary codecs for the DETR detection provider."""
...
DETR_PROVIDER_NODES: tuple[type[Node], ...] = (DetectObjects,)


__all__ = ["DETR_PROVIDER_NODES", "DetectObjects", "register_types"]
