"""Stable node shape and boundary codecs for the Depth Anything 3 provider."""
...
class ModelDepthPreprocessor(Node):
    ...
    def execute(
        ...
        *,
        ...
        del model, provider
        from .model import execute_depth_anything_v3

        return cls.outputs(image=execute_depth_anything_v3(image, resolution=resolution))
...
DEPTH_ANYTHING_V3_PROVIDER_NODES: tuple[type[Node], ...] = (ModelDepthPreprocessor,)
