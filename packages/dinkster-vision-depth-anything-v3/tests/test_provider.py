...
from dinkster_vision_depth_anything_v3 import model as depth_model
from dinkster_vision_depth_anything_v3 import register_types
from dinkster_vision_depth_anything_v3.da3 import OUT_LAYERS, PATCH_SIZE, DepthAnything3MonoLarge
from dinkster_vision_depth_anything_v3.model import (
...
MANIFEST = ROOT / "packages" / "dinkster-vision-depth-anything-v3" / "dinkster-pack.toml"
