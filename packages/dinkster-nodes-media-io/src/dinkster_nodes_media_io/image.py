...
MAX_IMAGE_FILE_BYTES = IMAGE_WORKING_SET_LIMIT_BYTES
MAX_IMAGE_ARRAY_BYTES = IMAGE_WORKING_SET_LIMIT_BYTES
MAX_ENCODED_IMAGE_BYTES = ENCODED_MEDIA_LIMIT_BYTES
