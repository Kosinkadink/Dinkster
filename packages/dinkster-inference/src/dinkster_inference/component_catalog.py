    ...
    for descriptor in (
        ...
        *control_component_descriptors(),
        ...
        _descriptor(
            ...
            attention_roles=("diffusion", "t5xxl", "vae"),
            attention_requires_route=True,
            loader_uses_device=True,
        ...
        _descriptor(
            ...
            vae_dtypes=(FLOAT32,),
            text_loader_hints=("minimax",),
            attention_roles=("diffusion", "text"),
            attention_requires_route=True,
        ...
        _descriptor(
            ...
            attention_roles=("diffusion", "gemma3_12b", "gemma4_12b", "connectors"),
