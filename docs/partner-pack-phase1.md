...
These node types have no Dinkster execution path until the linked gateway
adapter is available:

- Kosinkadink/dinkster-gateway#2: `partner.bfl.flux-pro-expand`,
  `partner.bfl.flux-pro-fill`, `partner.bfl.flux-erase`, and
  `partner.bfl.flux-vto`.
- Kosinkadink/dinkster-gateway#3: `partner.grok.video-reference`,
  `partner.grok.video-edit`, and `partner.grok.video-extend`.
- Kosinkadink/dinkster-gateway#4: `partner.kling.camera-control-i2-v`,
...
- Kosinkadink/dinkster-gateway#5: `partner.wan.reference-video`,
...
- Kosinkadink/dinkster-gateway#6: `dinkster.text_generate` and
